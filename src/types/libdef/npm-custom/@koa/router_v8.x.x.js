// @flow
// Coming from https://github.com/flow-typed/flow-typed/blob/master/definitions/npm/koa-router_v7.2.x/flow_v0.104.x-/koa-router_v7.2.x.js
// adapted by Julien for the newer @koa/router
...
declare module '@koa/router' {
  declare class Router {
    ...
    url(
      name: string,
      params?: any,
      options?: {| query: string | {} |} // parameter added in 7.3, added to libdef by julienw
    ): string | Error;
